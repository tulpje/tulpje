 ...
 * fix(tulpje-cache): clear old `guild_channels` when caching a guild ([`5378a5f`](https://github.com/tulpje/tulpje/commit/5378a5fd815a26eabd0e87f4b24e2b66305495ff))
</details>
 ...
 * chore(deps): update `twilight-cache-inmemory`, `twilight-gateway`, `twilight-http` and `twilight-model` from 0.17.0 to 0.17.1 ([`a79d238`](https://github.com/tulpje/tulpje/commit/a79d238af1c8672ec596be73b72f3b2974de3311))
 * fix(cache): remove catch-all for events, add missing ignored events ([`14a70f5`](https://github.com/tulpje/tulpje/commit/14a70f5b0000754be8d626438369d5bb72572d4f))
 ...
 * fix(cache): add `avatar_decoration_data` and `banner` fields to user ([`4366dec`](https://github.com/tulpje/tulpje/commit/4366dec57ab1bb7643e1a8c79bc9f03e3d22ee73))
 * fix(cache): remove deref ([`6121d0b`](https://github.com/tulpje/tulpje/commit/6121d0b3c82e11286bf9082ada2deec20b4d945e))
 * fix(cache): update User on MemberUpdate ([`d5a8737`](https://github.com/tulpje/tulpje/commit/d5a87377821d7c5e733d779d97fd39c55467e58b))
